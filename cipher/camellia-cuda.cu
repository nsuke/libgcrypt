...
extern "C" {
  ...
  /*
void camellia_encrypt_ocb(unsigned char* out,
...
__device__ const u32 camellia_sp1110[256] = {
...
__device__ const u32 camellia_sp0222[256] = {
...
__device__ const u32 camellia_sp3033[256] = {
...
__device__ const u32 camellia_sp4404[256] = {
 ...
 */
__global__
void camellia_encrypt128(const u32 *subkey, u32 *io_buf, const u32 *offset_buf)
{
...
__global__
void camellia_decrypt128(const u32 *subkey, u32 *io_buf, const u32 *offset_buf)
{
 ...
 */
__global__
void camellia_encrypt256(const u32 *subkey, u32 *io_buf, const u32 *offset_buf)
{
    uint32_t idx = blockIdx.x * blockDim.x + threadIdx.x;
    auto io = &io_buf[idx * 4];
    auto offset = &offset_buf[idx * 4];
...
__global__
void camellia_decrypt256(const u32 *subkey, u32 *io_buf, const u32 *offset_buf)
{
    uint32_t idx = blockIdx.x * blockDim.x + threadIdx.x;
    auto io = &io_buf[idx * 4];
    auto offset = &offset_buf[idx * 4];
...
void _gen_checksum(__int128_t* checksum, const __int128_t* data, size_t size)
{
